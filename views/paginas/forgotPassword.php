...
<div class="bg-[#9FBE4E] px-4 sm:px-1 md:px-10 lg:px-12 py-4 sm:py-1 md:py-10 lg:py-12 rounded-xl shadow-2xl w-[65%] max-w-[420px] md:max-w-[500px] lg:max-w-[550px] xl:w-[36%] flex flex-col justify-between border border-white/20 hover:shadow-[0_25px_50px_-12px_rgba(164,195,81,0.4)] transition-shadow duration-300 mt-12 sm:mt-20 md:mt-0 ml-auto mr-1 sm:mr-0 md:mr-0 relative z-20">
    <div>
        ...
        <h3 class="text-white text-xl sm:text-2xl md:text-3xl font-bold text-center mb-2 sm:mb-3 md:mb-5 drop-shadow-md">Restablecer contraseña</h3>

        <form class="flex flex-col gap-1.5 sm:gap-2 md:gap-3" action="/forgot-password" method="post">
            <div class="flex flex-col gap-0.5 sm:gap-1 md:gap-2">
                <label class="text-white text-[11px] sm:text-xs md:text-sm lg:text-base font-medium" for="email">Correo electronico</label>
            ...
            <div class="flex flex-col gap-0.5 sm:gap-1 md:gap-2">
                <label class="text-white text-[11px] sm:text-xs md:text-sm lg:text-base font-medium" for="password">Nueva contrasena</label>
                <input class="p-1.5 sm:p-2 md:p-2.5 lg:p-3 rounded-md border-2 border-transparent outline-none text-gray-600 text-[11px] sm:text-xs md:text-sm focus:outline-none focus:ring-2 focus:ring-[#BF7D24] focus:border-[#BF7D24] hover:border-[#BF7D24]/50 transition-all duration-200 shadow-sm" type="password" id="password" name="password" placeholder="Nueva contrasena">
            </div>

            <div class="flex flex-col gap-0.5 sm:gap-1 md:gap-2">
                <label class="text-white text-[11px] sm:text-xs md:text-sm lg:text-base font-medium" for="confirmPassword">Confirmar nueva contraseña</label>
                <input class="p-1.5 sm:p-2 md:p-2.5 lg:p-3 rounded-md border-2 border-transparent outline-none text-gray-600 text-[11px] sm:text-xs md:text-sm focus:outline-none focus:ring-2 focus:ring-[#BF7D24] focus:border-[#BF7D24] hover:border-[#BF7D24]/50 transition-all duration-200 shadow-sm" type="password" id="confirmPassword" name="confirmPassword" placeholder="Confirmar nueva contrasena">
            </div>

            <button type="submit" class="bg-[#CE8F3A] text-white font-bold py-1.5 sm:py-2 md:py-2.5 lg:py-3 px-5 sm:px-6 md:px-7 lg:px-8 rounded-full mt-1.5 sm:mt-2 md:mt-3 lg:mt-4 hover:bg-[#D99A45] hover:shadow-lg hover:shadow-[#CE8F3A]/40 transition-all duration-200 self-center text-[11px] sm:text-xs md:text-sm lg:text-base transform hover:scale-105 cursor-pointer active:scale-95">Actualizar contraseña</button>
        </form>
    </div>

    <div class="mt-4 sm:mt-6 md:mt-8">
        <hr class="border-t border-white/30 mb-3 sm:mb-4 md:mb-6 shadow-sm">
        <p class="text-white text-center text-[11px] sm:text-xs md:text-sm">Volver a <a href="/login" class="underline hover:text-white/80">Iniciar sesion</a></p>
    </div>
</div>
