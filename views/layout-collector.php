...
<body class="min-h-screen bg-[radial-gradient(circle,#8AB18D,#4D604F)]">
    ...
    <header class="w-[95%] md:w-[90%] mx-auto mt-3 sm:mt-4 bg-[#A4C351] rounded-2xl relative z-10 shadow-lg">
        <nav class="py-2 sm:py-3 md:py-4 px-3 sm:px-4 md:px-6 flex items-center justify-between">
            ...
            <ul class="hidden md:flex justify-center items-center gap-1 sm:gap-2 md:gap-4 text-xs sm:text-sm md:text-base">
                <li><a href="/home" class="px-2 sm:px-3 md:px-4 py-1 md:py-2 rounded-lg font-medium hover:bg-white/20 transition-colors">Home</a></li>
                <li><a href="/album" class="px-2 sm:px-3 md:px-4 py-1 md:py-2 rounded-lg font-medium hover:bg-white/20 transition-colors">Album</a></li>
                <li><a href="/market" class="px-2 sm:px-3 md:px-4 py-1 md:py-2 rounded-lg font-medium hover:bg-white/20 transition-colors">Tienda</a></li>
                <li><a href="/scoreboard" class="px-2 sm:px-3 md:px-4 py-1 md:py-2 rounded-lg font-medium hover:bg-white/20 transition-colors">Partidos</a></li>
                <li><a href="/feedOfertas" class="px-2 sm:px-3 md:px-4 py-1 md:py-2 rounded-lg font-medium hover:bg-white/20 transition-colors">Mercado</a></li>
            </ul>
            ...
            <div class="hidden md:flex items-center justify-end gap-2 md:gap-3">
                ...
                <a href="/profile" aria-label="Ir al perfil" class="rounded-full">
                    <img src="<?php echo htmlspecialchars($_SESSION['avatar_url'] ?? '/img/image3.png'); ?>" alt="Perfil" class="h-8 w-8 md:h-10 md:w-10 rounded-full object-cover">
                </a>
        ...
        <div id="mobileMenu" class="hidden md:hidden flex-col bg-[#9FBE4E] border-t border-white/20 rounded-b-2xl">
            <ul class="flex flex-col gap-0 py-2">
                ...
                <li><a href="/album" class="block px-4 py-3 text-sm font-medium hover:bg-white/20 transition-colors">Album</a></li>
                <li><a href="/market" class="block px-4 py-3 text-sm font-medium hover:bg-white/20 transition-colors">Tienda</a></li>
                <li><a href="/scoreboard" class="block px-4 py-3 text-sm font-medium hover:bg-white/20 transition-colors">Partidos</a></li>
                <li><a href="/feedOfertas" class="block px-4 py-3 text-sm font-medium hover:bg-white/20 transition-colors">Mercado</a></li>
                <li class="border-t border-white/20 mt-2"></li>
                <li><a href="/profile" class="block px-4 py-3 text-sm font-medium hover:bg-white/20 transition-colors">Perfil</a></li>
                <li><a href="/logout" class="block px-4 py-3 text-sm font-medium hover:bg-white/20 transition-colors">Salir</a></li>
            </ul>
        </div>
    </header>
        ...
        <div class="flex flex-col md:flex-row justify-between items-start gap-6 md:gap-10">
            ...
            <nav>
                <ul class="flex flex-wrap gap-4 sm:gap-6 md:gap-10 font-semibold text-xs sm:text-sm">
                    <li><a href="/home" class="hover:text-[#A4C351]/80">HOME</a></li>
                    <li><a href="/album" class="hover:text-[#A4C351]/80">ALBUM</a></li>
                    <li><a href="/market" class="hover:text-[#A4C351]/80">TIENDA</a></li>
                    <li><a href="/scoreboard" class="hover:text-[#A4C351]/80">PARTIDOS</a></li>
                    <li><a href="/feedOfertas" class="hover:text-[#A4C351]/80">MERCADO</a></li>
                </ul>
            </nav>
        </div>
